...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/publisher-management', title: 'Quản lý nhà xuất bản',  icon:'person', class: '' },
    { path: '/book-management', title: 'Quản lý sách ',  icon:'library_books', class: '' },
    { path: '/user-management', title: 'Quản lý User ',  icon:'person', class: '' },
